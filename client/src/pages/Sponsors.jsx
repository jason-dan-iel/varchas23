...
const Sponsors = () => {
  return (
    <section className="py-base container relative w-full h-screen mx-auto sm:px-16 px-6 sm:py-16 py-10 max-w-7xl justify-center items-center font-nova_square">
      {/* <Comingsoon /> */}
